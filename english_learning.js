/*!
 * English Learning for Lampa v0.1.0
...
/* SPDX-License-Identifier: GPL-2.0-only */
    ...
    LearningSettings.prototype.installUi = function () {
        var lampa = this.root.Lampa, api, self = this;
        ...
        lampa.SettingsApi.addComponent({ component: 'english_learning', name: text('english_learning_title', 'English Learning') });
